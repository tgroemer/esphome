...
EPaper2P9InBWR = waveshare_epaper_ns.class_(
    "EPaper2P9InBWR", WaveshareEPaperBWR
)
...
RESET_PIN_REQUIRED_MODELS = ("2.13inv2", "2.13in-ttgo-b74", "2.9in-bwr")
